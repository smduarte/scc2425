...
public interface Users {
    ...
    /**
     * Collects the information on the user identified by userId
     *
    ...
    /**
     * Modifies the information of a user. The Value of null, in any field of the user argument, means the field will remain as unchanged
     ...
     * @return OK when the search was successful, regardless of the number of hits (including zero hits).
     * BAD_REQUEST - otherwise.
     */
